...
module.exports = {
    ...
    findByUserid: function (id, params, callback) {
        ...
        let sql = "select topicid,userid from topicfollow where userid = " + "'" + id + "'"
        console.log("获取关注话题")
        console.log(sql)
    ...
    insert: function (obj, params, callback) {
     ...
     // 取消用户关注
     deleteByUserid: function (topicid,userid, params, callback) {
        //每次使用的时候需要创建链接，数据操作完成之后要关闭连接
        let sql = "delete from topicfollow where userid = " + "'" + userid + "' and topicid =" +"'"+topicid+"'"
        console.log("获取关注话题")
        console.log(sql)
        var connection = mysql.createConnection(data);
        connection.connect(function (err) {
    ...
    // 查询关注表是否存在某数据
    isExit: function (topicid,userid, params, callback) {
        //每次使用的时候需要创建链接，数据操作完成之后要关闭连接
        let sql = "select userid,topicid from topicfollow where userid = " + "'" + userid + "' and topicid =" +"'"+topicid+"'"
        console.log("获取关注话题")
        console.log(sql)
        var connection = mysql.createConnection(data);
        connection.connect(function (err) {
